package hsd.symptom.checker.seekbar;
...
class SmoothSeekBar extends View {
	...
	public static abstract class OnValueChanged {
		public abstract void ValueChanged(SmoothSeekBar seekbar,
				Integer new_value);
	}
	...
	public void onDraw(Canvas c) {
		 ...
		 * ().getDefaultDisplay().getMetrics(dm); int mul = dm.densityDpi;
		 */
		...
		Paint box = new Paint();
		box.setColor(getResources().getColor(R.color.primary)); // TODO: Base
																// off Holo

		c.drawRoundRect(new RectF(x, 0, x + biggestWidth, height()), 5, 5, box);

		text.setColor(getResources()
