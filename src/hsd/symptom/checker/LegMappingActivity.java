...
public class LegMappingActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.man_front_leg_mapping);
		cd = new ConnectionDetector(this);

		findViewById(R.id.man_front_legs).setOnTouchListener(
				new OnTouchListener() {
					...
					public boolean onTouch(View v, MotionEvent event) {
						...
						if (event.getAction() == MotionEvent.ACTION_DOWN) {
							...
							if (cd.isConnectingToInternet()) {
								...
								Toast.makeText(LegMappingActivity.this,
	...
	private int getColour(int x, int y) {
		ImageView img = (ImageView) findViewById(R.id.man_front_legs_clickable);
