...
public class DoctorListingFragment extends Fragment {
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		content = inflater.inflate(R.layout.doctor_list_activity, container,
				false);
		...
		pd.setMessage("Getting list of doctorss...");
		pd.setCancelable(false);
		pd.setIcon(R.drawable.ic_launcher);
		pd.setIndeterminate(true);

		listViewDoctors = (ListView) content.findViewById(R.id.listViewDoctors);
		...
		public View getView(final int position, View convertView,
			...
			view.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					args.putInt("doc_id", symptomList.get(position).getDoc_id());
