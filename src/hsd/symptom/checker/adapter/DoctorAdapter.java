...
public class DoctorAdapter extends ArrayAdapter<SugarBp> {
	private LayoutInflater mInflater;
	private List<SugarBp> mBp;

	public DoctorAdapter(Context context, int resource, List<SugarBp> Symptoms) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		ViewHolder holder;
		if (convertView == null) {
			view = mInflater.inflate(R.layout.doctor_card, parent, false);
