...
import hsd.symptom.checker.database.BP;
...
public class BPAdapter extends ArrayAdapter<BP> {
	...
	public BPAdapter(Context context, int resource, List<BP> Symptoms) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		BP symptom = mBp.get(position);

		holder.textView_symptom_name.setText(symptom.get_date());
		String cname = symptom.get_bp() + "";
		if (!cname.equals("")) {
